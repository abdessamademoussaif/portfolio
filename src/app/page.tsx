...
export const metadata: Metadata = {
  title: "Moussaif | Frontend Web Developer Portfolio",
  description:
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
          ...
          <div className="text-center lg:text-left lg:w-1/2">
            <p className="text-2xl text-gray-800 mb-2">
              Hey, {"I'm"} Moussaif <span className="inline-block">👋🏻</span>
            </p>
            ...
            <div className="mt-6 flex flex-col md:flex-row items-center lg:items-start justify-center lg:justify-start space-y-4 md:space-y-0 md:space-x-4">
              ...
              <a
                href="https://drive.usercontent.google.com/u/0/uc?id=1kRXMaBYy2qB9H6hN-XDvCiOGIDhnnSnK&export=download"
                target="_blank"
