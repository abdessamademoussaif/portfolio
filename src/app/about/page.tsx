...
export const metadata: Metadata = {
  title: "About | Moussaif - Frontend Developer",
  description:
    "Learn more about Moussaif, a frontend web developer specializing in React, Next.js, TypeScript, and modern web technologies.",
  keywords: [
    "About Moussaif",
    "Frontend Developer",
    "React Developer",
