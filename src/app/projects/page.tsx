...
export const metadata: Metadata = {
  title: "Projects | Moussaif - Frontend Developer",
  description:
    "Explore projects developed by Moussaif, a frontend web developer specializing in React, Next.js, TypeScript, and modern web technologies.",
  keywords: [
