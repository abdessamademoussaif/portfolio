...
export const metadata: Metadata = {
  title: "Contact | Moussaif - Frontend Developer",
  description:
    "Get in touch with Moussaif for web development projects, collaborations, and job opportunities.",
  keywords: [
    "Contact Moussaif",
          ...
          <div className="text-center lg:text-left md:w-1/2 lg:w-1/2 p-5">
            ...
            >
              ...
              <p className="text-[18px] text-gray-600">
                abdssamademoussaif@gmail.com
              </p>
            </Link>

            {/* Phone Link */}
            <Link
              href="tel:+212668258136"
              className="mt-6 flex gap-5 items-center"
            >
              <div className="p-3 border-2 border-gray-400 text-gray-600 rounded-full font-bold">
                <Phone />
              </div>
              <p className="text-[18px] text-gray-600">+212 668 258 136</p>
            </Link>
          </div>
